...
class CommonController extends Controller
{
    ...
    {
        !empty($model) && $this->model = $model;
        $add_success_url = $this->model['add_success_url'] ? $this->model['add_success_url'] : U('lists',
            array('addon' => get_addon()));
    ...
    {
        !empty($model) && $this->model = $model;
        $edit_success_url = $this->model['edit_success_url'] ? $this->model['edit_success_url'] : U('lists',
            array('addon' => get_addon()));
    ...
    {
        !empty($model) && $this->model = $model;
        $delete_success_url = $this->model['delete_success_url'] ? $this->model['delete_success_url'] : U('lists',
            array('addon' => get_addon()));
